  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('./views/LoginView.vue'), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'schedule', name: 'schedule', component: () => import('./views/PlaceholderView.vue'), meta: { menuKey: 'schedule', title: '排期调度' } },
        { path: 'samples', name: 'samples', component: () => import('./views/PlaceholderView.vue'), meta: { menuKey: 'samples', title: '样品管理' } },
        ...
        { path: 'audit', name: 'audit', component: () => import('./views/PlaceholderView.vue'), meta: { menuKey: 'audit', title: '流程日志' } },
